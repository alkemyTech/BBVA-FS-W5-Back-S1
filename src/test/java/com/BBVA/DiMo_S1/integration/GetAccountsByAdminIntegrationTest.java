...
public class GetAccountsByAdminIntegrationTest {
    ...
    @Test
    public void mostrarCuentasDeUserByAdminConExito() throws Exception {
        ...
        mockMvc.perform(get("/accounts/admin/{idUser}", 2L)
    ...
    @Test
    public void mostrarCuentasDeUserByUserFrobidden() throws Exception {
