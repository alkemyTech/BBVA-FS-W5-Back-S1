...
public class SendUsdIntegrationTest {
    ...
    @Test
    public void enviarUsdYcrearTransaccion() throws Exception {
        ...
        Optional<Account> emisora = accountRepository.getUsdAccountByIdUser(12L);
        Optional<Account> receptora = accountRepository.findByCbu("22234567890123456789");
        ...
        simpleTransactionDTO.setDescription("Transferencia de USD");
        ...
        MvcResult result = mockMvc.perform(post("/transactions/sendUsd")
        ...
        assertThat(accountRepository.getUsdAccountByIdUser(12L).get().getBalance()).
                isLessThan(balanceCuentaEmisoraViejo);
        assertThat(accountRepository.findByCbu("22234567890123456789").get().getBalance()).
